...
SEARCH_STOCKS_EXTENDED = [
    ...
    {"symbol": 'ADANIGAS', "name": 'Adani Gas'},
    ...
    {"symbol": 'BALMLAWRIE', "name": 'Balmer Lawrie'},
    ...
    {"symbol": 'DIVI', "name": 'Divis Laboratories'},
    ...
    {"symbol": 'KPIL', "name": 'Kalpataru Projects International'},
    ...
    {"symbol": 'LLOYDSENT', "name": 'Lloyds Metals & Energy'},
    {"symbol": 'LT', "name": 'Larsen & Toubro'},
    {"symbol": 'LTFOODS', "name": 'LT Foods'},
    {"symbol": 'LTIM', "name": 'LTIMindtree'},
    {"symbol": 'LTTS', "name": 'LT Technology Services'},
    ...
    {"symbol": 'PGHL', "name": 'Procter & Gamble Hygiene & Health'},
    ...
    {"symbol": 'PRINCEPIPE', "name": 'Prince Pipes and Fittings'},
    {"symbol": 'PSB', "name": 'Punjab & Sind Bank'},
    {"symbol": 'PTC', "name": 'PTC India'},
    ...
    {"symbol": 'RAMCOCEMENT', "name": 'Ramco Cements'},
    ...
    {"symbol": 'REDINGTON', "name": 'Redington India'},
    {"symbol": 'RELAXO', "name": 'Relaxo Footwears'},
    {"symbol": 'RELIANCE', "name": 'Reliance Industries'},
    {"symbol": 'RITES', "name": 'RITES'},
    {"symbol": 'RKFORGE', "name": 'Ramkrishna Forgings'},
    ...
    {"symbol": 'STCINDIA', "name": 'STC India'},
    ...
    {"symbol": 'TVSMOTORS', "name": 'TVS Motor Company'},
    {"symbol": 'UCOBANK', "name": 'UCO Bank'},
    {"symbol": 'UFLEX', "name": 'UFlex'},
    ...
    {"symbol": 'CHOLAHLDNG', "name": 'Cholamandalam Investment'},
    ...
    {"symbol": 'DWARKESH', "name": 'Dwarikesh Sugar'},
    ...
    {"symbol": 'HAPPIESTMND', "name": 'Happiest Minds'},
    ...
    {"symbol": 'INVENTURE', "name": 'Inventure Growth'},
    ...
    {"symbol": 'MANAKSTEEL', "name": 'Manak Steel & Power'},
    ...
    {"symbol": 'MLDL', "name": 'Mahindra Lifespace'},
    ...
    {"symbol": 'SONAMCLOCK', "name": 'Sona Comstar'},
